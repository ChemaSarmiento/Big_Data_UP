# Teoría — Sesión 09: Gobernanza, seguridad y capstone
...
- **Explicabilidad:** un modelo que niega o marca como sospechosa una transacción de
  ...
  logística (Sesión 5) tiene esta ventaja sobre modelos más opacos: sus coeficientes
...
- **Retención y borrado de datos:** normativas de protección de datos personales
  ...
  particionado (Sesión 6) facilita esto: borrar la partición correspondiente es
